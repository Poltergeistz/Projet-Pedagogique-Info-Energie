...
function create() {
  ...
  "Dégivrer son réfrigérateur = évite une surconsommation d’environ 30 %",
  ...
  "Si chaque ménage s’équipe en LED, on économise l’énergie d’une ville de 2 600 000 habitants (4000 MW)",
  ...
  "Fermez les volets et les rideaux la nuit pour garder la chaleur",
  ...
  // Style 
  var style = { font: "65px Kalam", fill: "#f9f9f9", align: "center" };

...
var game = new Phaser.Game(650, 455, Phaser.AUTO, '', { preload: preload, create: create, update: update });
...
function create() {
    ...
    player = game.add.sprite(game.world.width - 100, game.world.height - 150, 'dude');
	...
	*/
    ...
    timer.start();
    myHealthBar = new HealthBar(this.game, {width: 150, height: 10, x: 560, y: 15, bg:{color: '#651828'}, bar:{color: '#FEFF03'}, animationDuration: 200, flipped: false});

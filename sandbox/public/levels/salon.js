...
var salonState = {
  ...
  create: function() {
    ...
    //lampe
    lamp = game.add.sprite(650, 418, "lamp_active");
    ...
    //fenetre
    fenetre = game.add.sprite(450, 330, "fenetre");
    ...
    //tv
    tv = game.add.sprite(150, 450, "tv_active");
  ...
  closeWindow: function(){
    if (spaceKey.isDown) {
      fenetre.loadTexture('fenetre_active');
      fenetreFermee = true;
      score++;
    }
  }
